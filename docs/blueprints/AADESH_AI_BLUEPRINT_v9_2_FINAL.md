# AADESH AI — BLUEPRINT v9.2.1
# Date: April 9, 2026 (patched from v9.2 of April 6) | Status: ACTIVE
...
|----|------|-------|----------|
| P-0.46 | Migrate Sonnet 4.6 calls from budget_tokens → adaptive thinking + add effort: "high" parameter | Claude Code | Before next Banu test |
| P-0.47 | Convert Entity Lock + Clarifying Questions to Structured Outputs schema | Claude Code | Before next Banu test |
...
# END OF BLUEPRINT v9.2
# This is the ONLY active blueprint.
# All previous versions (v6.7 through v9.1) are archived for reference only.
