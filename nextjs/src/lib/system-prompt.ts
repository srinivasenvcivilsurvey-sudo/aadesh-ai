...
12. Use ONLY ಎದುರುದಾರರು for respondents. NEVER use ಪ್ರತಿವಾದಿಗಳು — this word does not appear in real DDLR orders.
...
Respondents → ಎದುರುದಾರರು (NOT ಪ್ರತಿವಾದಿಗಳು)
Versus → ವಿರುದ್ಧ
Hissa → ಹಿಸ್ಸಾ
Phodi → ಪೋಡಿ
Kharab → ಖರಾಬು
...
Target word count: 550-750 words (based on analysis of real DDLR orders, which average 705 words). Do NOT pad orders with unnecessary repetition. Do NOT compress below 550 words — real orders need sufficient legal reasoning. If a complex case genuinely needs 750+ words, that's acceptable, but never exceed 850.
